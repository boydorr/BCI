#' BCI 50 ha plot census data with 50m square quadrats
#'
...
#' this case we use 50m square quadrats.
#'
#' @source
...
#'   bci_50 %>% group_by(census) %>% summarise(total=sum(count))
#'
#'   # Look at the first quadrat of the first census
#'   bci_50 %>% filter(x==0, y==0, census==1)
"bci_50"
